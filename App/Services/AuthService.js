...
export const loginWithGoogle = () => {
    console.log("@@typeof", typeof GoogleSignIn);
    ...
    //     .then((data: any) => {
    //         // const credential: AuthCredential = firebase.auth.GoogleAuthProvider.credential(data.idToken, data.accessToken);
    ...
    //     //     console.log('@@Current user from svc', currentUser);
    //     //     return currentUser;
    //     // })
    //     .catch((error: any) => {
